...
case "$1" in
	...
	arm64v8)
		docker build ./ -t bayrell/alpine_mariadb:$VERSION-$SUBVERSION-arm64v8 --file Dockerfile --build-arg ARCH=-arm64v8
	;;
	...
	manifest)
		...
		docker push bayrell/alpine_mariadb:$VERSION-$SUBVERSION-arm64v8
		...
		docker manifest create --amend bayrell/alpine_mariadb:$VERSION-$SUBVERSION \
			...
			bayrell/alpine_mariadb:$VERSION-$SUBVERSION-arm64v8 \
	...
	*)
		echo "Usage: $0 {amd64|arm64v8|arm32v7|manifest|all}"
		RETVAL=1
